        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card className="bg-white/60 backdrop-blur-sm border border-gray-200/50">
              <CardHeader>
                <CardTitle className="text-lg font-medium text-gray-800">Recent Deals</CardTitle>
                <CardDescription>Latest deals closed this month</CardDescription>
              </CardHeader>
            ...
            <Card className="bg-white/60 backdrop-blur-sm border border-gray-200/50">
              <CardHeader>
                <CardTitle className="text-lg font-medium text-gray-800">Deal Pipeline</CardTitle>
            ...
            <Card className="bg-white/60 backdrop-blur-sm border border-gray-200/50">
              <CardHeader>
                <CardTitle className="text-lg font-medium text-gray-800">Revenue Tracking</CardTitle>
